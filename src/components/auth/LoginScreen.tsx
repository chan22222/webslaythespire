        ...
        {mode === 'select' ? (
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-all hover:scale-105 hover:brightness-110 disabled:opacity-50"
              style={{
                background: 'linear-gradient(180deg, #3a5030 0%, #1a2510 100%)',
                border: '2px solid #5a8040',
              }}
            >
              <span style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: '#a0d080' }}>
                로그인
              </span>
            </button>
            ...
            >
              <span style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: '#80c0e0' }}>
                회원가입
              </span>
            </button>
            ...
            <div className="flex items-center gap-4 my-4">
              ...
              <span style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: 'var(--gold-dark)', fontSize: '0.75rem' }}>
                소셜 로그인
              </span>
            ...
            >
              ...
              <span style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: '#d0ccc0' }}>
                Google로 로그인
              </span>
            </button>
            ...
            >
              ...
              <span style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: '#d0d0d0' }}>
                GitHub로 로그인
              </span>
            </button>
            ...
            >
              ...
              <span style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: 'var(--gold-light)' }}>
                게스트로 플레이
              </span>
            </button>
            ...
            {authError && (
              <p
                className="text-center text-xs py-2 px-3 rounded"
                style={{
            ...
            {/* 안내 텍스트 */}
            <p
              className="text-center mt-4 text-xs opacity-60"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <h2
              ...
              style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: 'var(--gold-light)', fontSize: '1.1rem' }}
            >
              {mode === 'login' ? '로그인' : '회원가입'}
            </h2>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 rounded-lg outline-none transition-all focus:ring-2 focus:ring-[var(--gold-dark)]"
                style={{
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-lg transition-all hover:scale-105 hover:brightness-110 disabled:opacity-50"
              style={{
            ...
            <button
              ...
              className="w-full py-2 text-center transition-all hover:brightness-125"
              style={{ fontFamily: '"NeoDunggeunmo", "Neo둥근모", cursive', color: 'var(--gold-dark)', fontSize: '0.85rem' }}
            >
              ← 뒤로
            </button>
          </form>
