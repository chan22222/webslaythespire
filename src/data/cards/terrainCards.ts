...
export const TOXIC_SWAMP: Card = {
  ...
  rarity: 'RARE',
  cost: 1,
  image: '/cards/terrain/toxic_swamp.png',
...
export const LAVA_ZONE: Card = {
  ...
  rarity: 'RARE',
  cost: 1,
  image: '/cards/terrain/lava_zone.png',
...
export const SACRED_GROUND: Card = {
  ...
  rarity: 'RARE',
  cost: 3,
  image: '/cards/terrain/sacred_ground.png',
...
export const GLADIATOR_ARENA: Card = {
  ...
  rarity: 'RARE',
  cost: 2,
  image: '/cards/terrain/gladiator_arena.png',
...
export const ZERO_GRAVITY: Card = {
  ...
  rarity: 'RARE',
  cost: 3,
  image: '/cards/terrain/zero_gravity.png',
...
export const THUNDER_WASTELAND: Card = {
  ...
  rarity: 'RARE',
  cost: 2,
  image: '/cards/terrain/thunder_wasteland.png',
  description: '매 턴 종료 시, 무작위 대상에게 3의 낙뢰 피해를 10번 입힙니다. 소멸.',
...
export const ANCIENT_LIBRARY: Card = {
  ...
  rarity: 'RARE',
  cost: 3,
  image: '/cards/terrain/ancient_library.png',
