...
export const SACRED_GROUND: Card = {
  ...
  description: '모든 캐릭터가 받는 모든 방어도가 1.5배가 됩니다. 소멸.',
  effects: [{ type: 'TERRAIN_SACRED_GROUND', value: 1.5 }],
  exhaust: true,
  upgraded: false,
};
...
export const GLADIATOR_ARENA: Card = {
  ...
  description: '모든 캐릭터가 주는 공격이 2배 증가하고, 방어도를 얻을 수 없습니다. 소멸.',
  effects: [{ type: 'TERRAIN_GLADIATOR_ARENA', value: 100 }],
  exhaust: true,
  upgraded: false,
};
