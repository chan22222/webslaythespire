  ...
  return (
    <>
      ...
      <div className="combat-bottom-area relative z-20 h-28 xs:h-32 sm:h-36 md:h-44 lg:h-56 pointer-events-none">
        ...
        {/* 에너지 오브 - 좌측 (안쪽으로) */}
        <div className="combat-energy-orb combat-scale absolute left-4 xs:left-6 sm:left-8 md:left-[6%] lg:left-[10%] bottom-8 xs:bottom-10 sm:bottom-12 md:bottom-18 lg:bottom-20 z-30 scale-[0.5] xs:scale-[0.55] sm:scale-[0.7] md:scale-90 lg:scale-110 origin-bottom-left pointer-events-auto">
          <EnergyOrb current={energy} max={maxEnergy} />
        </div>

        {/* 카드 패 - 중앙 하단 */}
        <div className="combat-card-area absolute inset-x-0 bottom-0 flex justify-center items-end pointer-events-none">
        ...
        {/* 턴 종료 버튼 - 우측 하단 */}
        <div
          className="combat-end-turn combat-scale absolute right-4 xs:right-6 sm:right-8 md:right-[6%] lg:right-[10%] bottom-8 xs:bottom-10 sm:bottom-12 md:bottom-10 lg:bottom-[4.25rem] z-30 scale-[0.5] xs:scale-[0.55] sm:scale-[0.7] md:scale-90 lg:scale-110 origin-bottom-right pointer-events-auto"
